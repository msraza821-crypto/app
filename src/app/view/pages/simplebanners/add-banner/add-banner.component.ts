...
this.viewBanner()
  ...
  changeProduct()
  {
    ...
    if(this.bannerForm.value.available_on=='product')
    {
      this.isProduct=true;
      this.isBrand=false;
      return;
  ...
  onSubmit()
  {
    ...
    if (this.bannerForm.valid) {
      ...
      formData.append('name', this.bannerForm.value.title);
     formData.append('description', this.bannerForm.value.minimum_value);
      formData.append('name_ar', this.bannerForm.value.discount_value);
      formData.append('description_ar', this.bannerForm.value.discount_value);
    
      console.log(formData)
      this.api
      .postReqAuth("admin/banner/add",formData).subscribe(
...
console.log('from discount change')
  if(this.bannerForm.value.discount_type=='flat')
